		...
		if (result_content.length) {
			if (result_content[0] == 'Testing') {
				result_stat.innerHTML = "<span style='color:green;font-weight:bold'>" +
					"&emsp;<img src='" + L.resource(['/www/luci-static/argon/icon/loading.svg']) + "' height='17' style='vertical-align:middle'/>" +
			...
			if (result_content.length) {
				if (result_content[0] == 'Testing') {
					return E('div', { 'id': 'speedtest_result' }, [E('span', { 'style': 'color:yellow;font-weight:bold' }, [
						E('img', { 'src': L.resource(['/www/luci-static/argon/icon/loading.svg']), 'height': '20', 'style': 'vertical-align:middle' }),
						'&emsp;',
